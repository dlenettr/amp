...
.background {
	height: 35px;
	background: #ee4623 url({THEME}/images/bg.jpg) repeat-x;
}
...
#footmenu {
	...
	height: 1%;
	padding: 20px;
	background: #2d2d2d url({THEME}/images/dbg.png);
}
...
<body>
	...
	<header id="header">
		<a id="logo" href="#">
			<b id="logo-text">Siteniz</b>
			<span>Slogan</span>
		</a>
		<a id="go2full" class="ico" href="{normal-url}">Tam sürüme geç</a>
	</header>
	<section id="content">
		{amp-content}
	</section>
	<footer id="footer">
		<div class="background"></div>
		<div id="copyright">Powered by <a href="https://dle-news.ru" target="_blank">DataLife Engine</a> © 2019</div>
	</footer>
</body>
</html>